...
const products = [
    ...
    { id: 38, name: "Boho Chain Earring", price: "AED 35.00", category: "under-50", type: "earrings", image: "assets/products/boho-chain-earring", desc: "Free-spirited boho chain earrings in a refined silver finish." },
    { id: 39, name: "Chain Loop Earrings", price: "AED 30.00", category: "under-30", type: "earrings", image: "assets/products/chain-loop-earrings", desc: "Sculptural linked loop earrings with a sleek modern edge." },
    { id: 40, name: "Chunky Silver Hoops", price: "AED 32.00", category: "under-50", type: "earrings", image: "assets/products/chuncy-silver-hoops", desc: "Bold chunky silver hoops with a lustrous satin finish." },
    { id: 41, name: "Crystal Cherry Hoops", price: "AED 25.00", category: "under-30", type: "earrings", image: "assets/products/crystal-cherry-hoops", desc: "Cherry red crystal drop earrings with luminous glass accents." },
    { id: 42, name: "Dual Tone Oval Drops", price: "AED 40.00", category: "under-50", type: "earrings", image: "assets/products/dual-tone-oval-drops-earrings", desc: "Dual-tone oval drop earrings blending warm and cool metallics." },
    { id: 43, name: "Garnet Glare Asymmetrical Drops", price: "AED 55.00", category: "under-100", type: "earrings", image: "assets/products/garnet-glare-asymmetrical-drops", desc: "Asymmetrical garnet drops with a rich ruby glare finish." },
    { id: 44, name: "Garnet Glare Drops", price: "AED 55.00", category: "under-100", type: "earrings", image: "assets/products/garnet-glare-drops", desc: "Classic garnet glare drop earrings with deep crimson stones." },
    { id: 45, name: "Garnet Glare Hollow Drops", price: "AED 60.00", category: "under-100", type: "earrings", image: "assets/products/garnet-glare-hollow-drops", desc: "Hollow garnet drop earrings in a radiant crimson tone." },
    { id: 46, name: "Green Crescent Earrings", price: "AED 38.00", category: "under-50", type: "earrings", image: "assets/products/green-crescent-earrings", desc: "Emerald crescent earrings with a soft vintage glow." },
    { id: 47, name: "Luna Layered Ear Cuffs Set", price: "AED 35.00", category: "under-50", type: "earrings", image: "assets/products/luna-layered-ear-cuffs-set", desc: "Layered lunar ear cuff set in polished gold tones." },
    { id: 48, name: "Rainbow Crystal Drops", price: "AED 52.00", category: "under-100", type: "earrings", image: "assets/products/rainbow-crystal-drops", desc: "Iridescent rainbow crystal drop earrings with prismatic sparkle." },
    { id: 49, name: "Bianca Handcuff", price: "AED 45.00", category: "under-50", type: "bracelets", image: "assets/products/bianca-handcuff", desc: "Sculptural bianca handcuff bracelet in a statement silhouette." },
    { id: 50, name: "Cleopatra Handcuff", price: "AED 65.00", category: "under-100", type: "bracelets", image: "assets/products/cleopatra-handcuff", desc: "Regal cleopatra handcuff bracelet with bold engraved detailing." },
    { id: 51, name: "Kelly Gold Handcuff", price: "AED 48.00", category: "under-50", type: "bracelets", image: "assets/products/kelly-gold-handcuff", desc: "Opulent gold handcuff bracelet with a flawless mirror shine." },
    { id: 52, name: "Melted Gold Handcuff", price: "AED 65.00", category: "under-100", type: "bracelets", image: "assets/products/melted-gold-handcuff", desc: "Artistic melted gold handcuff bracelet in a fluid luxury form." },
];
  /* ------------------------------------------------------------------ *
