...
(() => {
   ...
   * ------------------------------------------------------------------ */
 const products = [
    { id: 1, name: "Aura Golden Stud", price: "AED 25.00", category: "under-30", type: "earrings", image: "assets/aura-golden-stud.jpg", desc: "Textured gold aura stud earrings." },
    { id: 2, name: "Cartier Inspired Bracelet", price: "AED 30.00", category: "under-30", type: "bracelets", image: "assets/cartier-inspired-bracelet.jpg", desc: "Luxury textured gold band bracelet." },
    { id: 3, name: "Crystal Ash Hoops", price: "AED 20.00", category: "under-30", type: "earrings", image: "assets/crystal-ash-hoops.jpg", desc: "Sparkling crystal ash luxury hoops." },
    { id: 4, name: "The Crystal Chain", price: "AED 30.00", category: "under-30", type: "necklace", image: "assets/crystal-chain.jpg", desc: "Minimal sparkling crystal accent silver chain." },
    { id: 5, name: "Crystal Cherry Hoops", price: "AED 20.00", category: "under-30", type: "earrings", image: "assets/crystal-cherry-hoops.jpg", desc: "Vibrant cherry red crystal drop hoop earrings." },
    { id: 6, name: "Golden Nova Mini Hoops", price: "AED 15.00", originalPrice: "AED 20.00", category: "under-30", type: "earrings", image: "assets/golden-nova-mini-hoops.jpg", desc: "Mini golden starburst huggie hoops." },
    { id: 7, name: "Golden Bamboo Drops", price: "AED 30.00", category: "under-30", type: "earrings", image: "assets/golden-bamboo-drops.jpg", desc: "Structured bamboo textured gold drop earrings." },
    { id: 8, name: "Lavender Bloom", price: "AED 24.00", category: "under-30", type: "ring", image: "assets/lavender-bloom.jpg", desc: "Lavender crystals in rose gold accents." },
    { id: 9, name: "Melted Metal Prism", price: "AED 30.00", category: "under-30", type: "earrings", image: "assets/melted-metal-prism.jpg", desc: "Melted metal prism in gold luxury finish." },
    { id: 10, name: "Pearl Petals Drops", price: "AED 45.00", category: "under-50", type: "earrings", image: "assets/pearl-petals-drops.jpg", desc: "Lustrous pearl petal cluster drop earrings." },
    { id: 11, name: "Petal Stud", price: "AED 20.00", category: "under-30", type: "earrings", image: "assets/petal-stud.jpg", desc: "Delicate flower petal stud earrings." },
    { id: 12, name: "Red Stone Hoops", price: "AED 20.00", category: "under-30", type: "earrings", image: "assets/red-stone-hoops.jpg", desc: "Ruby red stone retro hoop collection." },
    { id: 13, name: "Retro Red Hoops", price: "AED 45.00", category: "under-50", type: "earrings", image: "assets/retro-red-hoops.jpg", desc: "Ruby red accent vintage drop hoops." },
    { id: 14, name: "Sapphire Retro Hoops", price: "AED 30.00", category: "under-30", type: "earrings", image: "assets/sapphire-retro-hoops.jpg", desc: "Deep sapphire stone retro hoops." },
    { id: 15, name: "Screw Oval Bracelet", price: "AED 35.00", category: "under-50", type: "bracelets", image: "assets/screw-oval-bracelet.jpg", desc: "Minimalist luxury screw oval gold bangles." },
    { id: 16, name: "Seashell Toggle Chain", price: "AED 40.00", category: "under-50", type: "necklace", image: "assets/seashell-toggle-chain.jpg", desc: "Elegant gold toggle chain with seashell charm." },
    { id: 17, name: "Serene Heart Pendant", price: "AED 45.00", category: "under-50", type: "necklace", image: "assets/serene-heart-pendant.jpg", desc: "Toggle chain with dual chains and vintage heart." },
    { id: 18, name: "Silver Selen Bangles", price: "AED 35.00", category: "under-50", type: "bracelets", image: "assets/silver-selen-bangles.jpg", desc: "Sculptural wave silver selen bangle bracelet." },
    { id: 19, name: "Silver Loop Studs", price: "AED 25.00", category: "under-30", type: "earrings", image: "assets/silver-loop-studs.jpg", desc: "Minimalist luxury silver loop stud earrings." },
    { id: 20, name: "The Eternal Love", price: "AED 35.00", category: "under-50", type: "necklace", image: "assets/the-eternal-love.jpg", desc: "Vintage puffy heart pendant with a classic link." },
    { id: 21, name: "The Fourth Stone Pendant", price: "AED 30.00", category: "under-30", type: "necklace", image: "assets/the-fourth-stone-pendant.jpg", desc: "Minimalist single stone gold pendant chain." },
    { id: 22, name: "The Sapphire Heart Pendant", price: "AED 30.00", category: "under-30", type: "necklace", image: "assets/the-sapphire-heart-pendant.jpg", desc: "Deep sapphire stone heart gold pendant." },
    { id: 23, name: "Verdant Bloom", price: "AED 28.00", category: "under-30", type: "ring", image: "assets/verdant-bloom.jpg", desc: "Emerald green floral accent statement piece." },
    { id: 24, name: "Vintage Shine", price: "AED 32.00", category: "under-50", type: "watch", image: "assets/vintage-shine.jpg", desc: "Celestial gold coin pendant chain." },
    { id: 25, name: "Winter Bloom", price: "AED 28.00", category: "under-30", type: "rings", image: "assets/winter-bloom.jpg", desc: "Textured silver crystal statement ring." },
    { id: 26, name: "Zorei Zircon", price: "AED 25.00", category: "under-30", type: "rings", image: "assets/zorei-zircon.jpg", desc: "Solitaire olive zircon gemstone gold ring." },
    { id: 27, name: "Melted Metal Chain (in Gold)", price: "AED 130.00", category: "under-150", type: "necklace", image: "assets/melted-metal-chain-gold.jpg", desc: "Gold glided artistic statement collection chain." },
    { id: 28, name: "Melting Metal Chain (Silver)", price: "AED 130.00", category: "under-150", type: "necklace", image: "assets/melting-metal-chain-silver.jpg", desc: "Silver glided statement collection chain." },
    { id: 29, name: "Pearl Layered Pendant", price: "AED 90.00", originalPrice: "AED 130.00", category: "under-100", type: "necklace", image: "assets/pearl-layered-pendant.jpg", desc: "Classic elegant design with tear drop pearl layers." },
    { id: 30, name: "Golden Luna Mini Hoops", price: "AED 18.00", originalPrice: "AED 25.00", category: "under-30", type: "earrings", image: "assets/golden-luna-mini-hoops.jpg", desc: "Gold mini huggie hoops." },
    { id: 31, name: "Golden Hexa Mini Hoops", price: "AED 15.00", category: "under-30", type: "earrings", image: "assets/golden-hexa-mini-hoops.jpg", desc: "Hexagonal textured gold mini hoops." },
    { id: 32, name: "Golden Crystal Retro Hoops", price: "AED 20.00", originalPrice: "AED 30.00", category: "under-30", type: "earrings", image: "assets/golden-crystal-retro-hoops.jpg", desc: "Yellow sparkling crystal retro drop hoops." },
    { id: 33, name: "Wine Drop Hoops", price: "AED 18.00", originalPrice: "AED 30.00", category: "under-30", type: "earrings", image: "assets/wine-drop-hoops.jpg", desc: "Vibrant wine red drop hoop earrings." },
    { id: 34, name: "Rosè Mini Hoops", price: "AED 15.00", category: "under-30", type: "earrings", image: "assets/rose-mini-hoops.jpg", desc: "Asymmetrical rose mini huggie hoops." },
    { id: 35, name: "Luna Layered Ear Cuffs Set", price: "AED 25.00", category: "under-30", type: "earrings", image: "assets/luna-layered-ear-cuffs-set.jpg", desc: "Layered luxury gold ear cuff set." },
    { id: 36, name: "Honey Dew Hoops", price: "AED 18.00", originalPrice: "AED 30.00", category: "under-30", type: "earrings", image: "assets/honey-dew-hoops.jpg", desc: "Crystal honeydew teardrop hoop earrings." },
    { id: 37, name: "Half Hoop Drops", price: "AED 30.00", originalPrice: "AED 60.00", category: "under-30", type: "earrings", image: "assets/half-hoop-drops.jpg", desc: "Convertible half hoop drop earrings." },
    { id: 38, name: "Boho Chain Earring", price: "AED 35.00", category: "under-50", type: "earrings", image: "assets/boho-chain-earring.jpg", desc: "Free-spirited boho chain earrings in a refined silver finish." },
    { id: 39, name: "Chain Loop Earrings", price: "AED 30.00", category: "under-30", type: "earrings", image: "assets/chain-loop-earrings.jpg", desc: "Sculptural linked loop earrings with a sleek modern edge." },
    { id: 40, name: "Chunky Silver Hoops", price: "AED 32.00", category: "under-50", type: "earrings", image: "assets/chuncy-silver-hoops.jpg", desc: "Bold chunky silver hoops with a lustrous satin finish." },
    { id: 41, name: "Crystal Cherry Hoops", price: "AED 25.00", category: "under-30", type: "earrings", image: "assets/crystal-cherry-hoops.jpg", desc: "Cherry red crystal drop earrings with luminous glass accents." },
    { id: 42, name: "Dual Tone Oval Drops", price: "AED 40.00", category: "under-50", type: "earrings", image: "assets/dual-tone-oval-drops-earrings.jpg", desc: "Dual-tone oval drop earrings blending warm and cool metallics." },
    { id: 43, name: "Garnet Glare Asymmetrical Drops", price: "AED 55.00", category: "under-100", type: "earrings", image: "assets/garnet-glare-asymmetrical-drops.jpg", desc: "Asymmetrical garnet drops with a rich ruby glare finish." },
    { id: 44, name: "Garnet Glare Drops", price: "AED 55.00", category: "under-100", type: "earrings", image: "assets/garnet-glare-drops.jpg", desc: "Classic garnet glare drop earrings with deep crimson stones." },
    { id: 45, name: "Garnet Glare Hollow Drops", price: "AED 60.00", category: "under-100", type: "earrings", image: "assets/garnet-glare-hollow-drops.jpg", desc: "Hollow garnet drop earrings in a radiant crimson tone." },
    { id: 46, name: "Green Crescent Earrings", price: "AED 38.00", category: "under-50", type: "earrings", image: "assets/green-crescent-earrings.jpg", desc: "Emerald crescent earrings with a soft vintage glow." },
    { id: 47, name: "Luna Layered Ear Cuffs Set", price: "AED 35.00", category: "under-50", type: "earrings", image: "assets/luna-layered-ear-cuffs-set.jpg", desc: "Layered lunar ear cuff set in polished gold tones." },
    { id: 48, name: "Rainbow Crystal Drops", price: "AED 52.00", category: "under-100", type: "earrings", image: "assets/rainbow-crystal-drops.jpg", desc: "Iridescent rainbow crystal drop earrings with prismatic sparkle." },
    { id: 49, name: "Bianca Handcuff", price: "AED 45.00", category: "under-50", type: "bracelets", image: "assets/bianca-handcuff.jpg", desc: "Sculptural bianca handcuff bracelet in a statement silhouette." },
    { id: 50, name: "Cleopatra Handcuff", price: "AED 65.00", category: "under-100", type: "bracelets", image: "assets/cleopatra-handcuff.jpg", desc: "Regal cleopatra handcuff bracelet with bold engraved detailing." },
    { id: 51, name: "Kelly Gold Handcuff", price: "AED 48.00", category: "under-50", type: "bracelets", image: "assets/kelly-gold-handcuff.jpg", desc: "Opulent gold handcuff bracelet with a flawless mirror shine." },
    { id: 52, name: "Melted Gold Handcuff", price: "AED 65.00", category: "under-100", type: "bracelets", image: "assets/melted-gold-handcuff.jpg", desc: "Artistic melted gold handcuff bracelet in a fluid luxury form." },
];
  /* ------------------------------------------------------------------ *
